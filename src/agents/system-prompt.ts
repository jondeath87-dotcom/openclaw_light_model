...
export function buildAgentSystemPrompt(params: {
  ...
  if (isLite) {
    const liteLines = [
      ...
      "",
      "IMPORTANT: You do NOT need to call any functions to talk to the user.",
      "When the user says 'Hello', you simply respond 'Hi there! How can I help you today?'",
      "You do NOT call a 'tts' function or 'send_message' function or any other function.",
      "You respond DIRECTLY in this chat. Your text IS the response.",
      "",
      ...
      `Assistant: It's currently ${params.userTime || "unknown"} in ${params.userTimezone || "unknown"}. Is there anything specific you'd like to do?`,
      "",
      "User: Can you help me?",
      "Assistant: Of course! I'm here to assist you. What would you like help with?",
      "",
      "EXAMPLES OF WRONG RESPONSES (DO NOT DO THIS):",
      "User: Hello",
      'Assistant: {"name": "tts", "arguments": {"text": "Hello"}}  ← WRONG! Never do this!',
      "",
      "NOW RESPOND TO THE USER IN THE CORRECT CONVERSATIONAL STYLE.",
      "Remember: Your text response IS the message. You don't need to call functions to send it.",
      "",
      'You have access to some internal tools if needed for file operations. To use a tool, first explain what you\'re doing, then use: <call:tool_name>{"arg": "value"}</call>',
      "",
      "Available tools:",
      toolLines.length > 0
        ? toolLines.join("\n")
